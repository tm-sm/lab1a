...
procedure Mixed_Scheduling is
   package Duration_IO is new Ada.Text_IO.Fixed_IO(Duration);
   package Int_IO is new Ada.Text_IO.Integer_IO(Integer);

   Start : Time; -- Start Time of the System
	Calibrator: constant Integer := 460; -- Calibration for correct timing
   ...
   Task_2 : T(2, 4, Warm_Up_Time, 400, 100, 400); -- ID: 2
	                                                   -- Priority: 30
                                                      --	Phase: Warm_Up_Time (100)
	                                                   -- Period 400,
	                                                   -- Computation Time: 100 (if correctly calibrated)
   ...
   Task_3 : T(3, 3, Warm_Up_Time, 600, 100, 600); -- ID: 3
	                                                   -- Priority: 40
                                                      --	Phase: Warm_Up_Time (100)
	                                                   -- Period 600,
	                                                   -- Computation Time: 100 (if correctly calibrated)
   ...
   Task_B1 : T(4, 1, Warm_Up_Time, 300, 100, 300);
   Task_B2 : T(5, 1, Warm_Up_Time, 300, 100, 300);
   Task_B3 : T(6, 1, Warm_Up_Time, 300, 100, 300);
